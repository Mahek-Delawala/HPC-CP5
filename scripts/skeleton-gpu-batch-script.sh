...
for B in 1 4 16 64 256 1024 4096
    do
        for N in 32 64 128 256 512 1024
            do
            echo "Threads Per Block=$N nBlocks=$B"
ncu --set default --section SourceCounters --metrics smsp__cycles_active.avg.pct_of_peak_sustained_elapsed,dram__throughput.avg.pct_of_peak_sustained_elapsed,gpu__time_duration.avg ../build/sobel_gpu -N $N -B $B
            done
    done
